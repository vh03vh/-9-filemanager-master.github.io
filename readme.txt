...
# Sulata File Manager #
#######################
* To run the script, unzip and place the extracted files in a folder named 'filemanager' in the root of your web server.
* This directory is also know as 'DocumentRoot'.
